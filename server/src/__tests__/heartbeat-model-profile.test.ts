...
describe("heartbeat model profile application", () => {
  it("keeps cheap profile disabled when the agent has no runtime override", async () => {
  ...
  it("applies enabled cheap profile patches before explicit issue adapter config overrides", () => {
    const modelProfile = resolveModelProfileApplication({
